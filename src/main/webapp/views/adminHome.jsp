        ...
        <div class="col-sm-3 pt-4">
          <div class="card border border-info" style="background-color: white">
            <div class="card-body text-center">
              ...
              <p>---------------------------------------------</p>
              <p class="card-text">Manage the cuisines section here.</p>
              <a href="/admin/categories" class="card-link btn btn-primary"
                >Manage</a
              >
            </div>
          </div>
        ...
        <div class="col-sm-3 pt-4">
          <div class="card" style="background-color: white">
            <div class="card-body text-center">
              ...
              <p>---------------------------------------------</p>
              <p class="card-text">Manage all the dishes here.</p>
              <a href="/admin/products" class="card-link btn btn-primary"
                >Manage</a
              >
            </div>
          </div>
        ...
        <div class="col-sm-3 pt-4">
          <div class="card" style="background-color: white">
            <div class="card-body text-center">
              ...
              <a href="/admin/customers" class="card-link btn btn-primary"
                >Manage</a
              >
            </div>
          </div>
